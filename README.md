...
zyqn의 개인 홈페이지이자 Astro 기반 포트폴리오/블로그입니다. 메인 페이지에는 현재 관심사, 프로젝트, 작업 원칙, 과거 퍼블리싱/프론트엔드 실습 결과물을 정리하고, `/blog`에는 제작기와 실험 기록을 Markdown으로 쌓습니다.
...
- Markdown 기반 블로그
- 소개, 문의, 개인정보처리방침 페이지
- sitemap, robots.txt 등 검색 노출을 위한 기본 파일
