...
```text
오늘 있었던 일: 블로그 글 초안을 작성했다.
기분 변화: 시작 전에는 막막했지만, 목차를 잡고 나니 편해졌다.
잘한 점: 일단 발행 가능한 형태까지 밀어붙였다.
아쉬운 점: 제목을 너무 늦게 고민했다.
다음 행동 하나: 다음 글은 제목 후보를 먼저 5개 적고 시작한다.
```
...
```text
사건: 회의에서 준비한 의견을 끝까지 말하지 못했다.
해석: 긴장하면 핵심 문장을 먼저 꺼내지 못하는 편이다.
다음 행동: 다음 회의 전에는 말할 문장 1개를 미리 적어둔다.
```
...
```text
반복된 문제: 글을 쓸 때 제목을 뒤로 미룸
줄일 일: 본문부터 길게 쓰기
늘릴 일: 제목과 썸네일 문구 먼저 잡기
다음 행동: 글 시작 전에 제목 후보 5개 작성
```
...
```text
AI: 이번 주 기록에서 반복된 주제는 글쓰기 지연, 수면 부족, 회의 피로입니다.
사람: 다음 주에는 글쓰기 시간을 오전으로 옮겨본다.
```
