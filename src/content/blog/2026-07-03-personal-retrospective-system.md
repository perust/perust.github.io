...
## 기록이 끊겼을 때 다시 시작하는 장치

회고 시스템에서 가장 위험한 순간은 하루를 빼먹은 다음 날입니다. 그때 "어제 것도 채워야지"라고 생각하면 부담이 커지고, 며칠 비어 있는 노트를 보면 괜히 실패한 것 같아 더 손이 안 갑니다. 기록 습관의 목표는 빈칸 없는 달력을 만드는 게 아니라, 다시 돌아오기 쉬운 입구를 만드는 것입니다.

그래서 빈칸 허용 규칙을 미리 정해두는 편이 낫습니다.

<div class="routine-template">
<ul>
  <li>하루 빠져도 보충하지 않기</li>
  <li>3일 비어도 오늘 기록부터 다시 쓰기</li>
  <li>지난 기록을 채우기보다 다음 기록을 남기기</li>
</ul>
</div>

오랜만에 기록을 열었을 때 쓸 시작 문장도 정해두면 좋습니다. "며칠 비었지만 오늘부터 다시 쓴다", "지금 기억나는 것만 남긴다", "오늘은 한 줄만 적는다" 정도면 충분합니다. 공백을 설명하려고 애쓰다가 지치는 것보다, 오늘 기록부터 남기는 편이 오래 갑니다.

도구보다 먼저 정할 것은 입력 위치입니다. 잠들기 전 침대에서 쓸지, 출근길에 모바일로 쓸지, 업무 끝나고 노트북에서 쓸지가 정해져야 도구도 맞출 수 있습니다. 기록은 멋진 저장소보다 자주 열리는 입구가 먼저입니다.
