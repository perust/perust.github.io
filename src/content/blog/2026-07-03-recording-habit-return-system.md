...
<ul>
  <li>매일 30분씩 써야 한다.</li>
  <li>하루를 제대로 정리해야 한다.</li>
  <li>느낀 점과 배운 점까지 다 적어야 한다.</li>
  <li>나중에 봐도 괜찮은 문장으로 남겨야 한다.</li>
</ul>
</div>
...
<div class="routine-kv">
  <div><dt>기억할 일</dt><dd>댓글 기능 배포</dd></div>
  <div><dt>기분</dt><dd>뿌듯함</dd></div>
  <div><dt>내일 할 일</dt><dd>삭제 비밀번호 테스트</dd></div>
</div>
...
<div class="routine-template">
<ul>
  <li>잠들기 전 침대에서 쓸 것인가</li>
  <li>출근길에 모바일로 쓸 것인가</li>
  <li>업무 끝나고 노트북에서 쓸 것인가</li>
  <li>아침에 전날 기록을 남길 것인가</li>
</ul>
</div>
...
<div class="routine-template">
<ul>
  <li>며칠 비었지만 오늘부터 다시 쓴다.</li>
  <li>지금 기억나는 것만 남긴다.</li>
  <li>오늘은 한 줄만 적는다.</li>
</ul>
</div>
...
<div class="routine-kv">
  <div><dt>하루 기록</dt><dd>댓글 기능 붙이다가 D1 바인딩에서 막힘</dd></div>
  <div><dt>주간 회고</dt><dd>정적 블로그에 입력 기능을 붙일 때 서버가 필요함</dd></div>
  <div><dt>블로그 글</dt><dd>깃허브 블로그에 댓글 기능 붙이기</dd></div>
</div>
...
<div class="routine-kv">
  <div><dt>매일</dt><dd>오늘 기억할 일 하나</dd></div>
  <div><dt>매일</dt><dd>오늘 기분 한 단어</dd></div>
  <div><dt>매일</dt><dd>내일 할 일 하나</dd></div>
  <div><dt>매주</dt><dd>반복된 패턴 하나</dd></div>
  <div><dt>매주</dt><dd>다음 주 행동 하나</dd></div>
</div>
