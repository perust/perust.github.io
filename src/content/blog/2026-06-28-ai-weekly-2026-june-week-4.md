...
| 6월 23일 | 협업 에이전트 | Anthropic, Slack용 Claude Tag 발표 | Anthropic 공식 발표 |
| 6월 22~26일 | AI 코딩 | GitHub Copilot CLI, Jira, Desktop, JetBrains, 코드 리뷰 업데이트 | GitHub Changelog |
| 6월 26일 | AI 코딩 | GitHub, MAI-Code-1-Flash를 Copilot Business/Enterprise에 GA | GitHub Changelog |
| 6월 25일 | AI 코딩 | GitHub, Copilot agentic harness 평가 글 공개 | GitHub Blog |
| 6월 25~26일 | 자동화 | n8n, self-improving agent skill workflow와 AI maturity 글 공개 | n8n Blog |
| 6월 25일 | 에이전트 효율 | MIT, AI agent workflow 비용·에너지 효율 개선 연구 소개 | MIT News |
| 6월 25일 | 기업 AI | AWS, agentic AI와 data mesh 전략 소개 | AWS Blog |
| 6월 22일 | AI 인프라 | Microsoft, 텍사스 Pecos AI 데이터센터 발표 | Microsoft Blog |
| 6월 22일 | AI 인프라 | NVIDIA, 유럽 내 35개 AI/HPC 슈퍼컴퓨터 개발 발표 | NVIDIA Newsroom |
| 6월 24~25일 | AI 보안 | Praxen, Gaslight malware 등 에이전트·AI 분석 보안 이슈 | Help Net Security / BleepingComputer |
