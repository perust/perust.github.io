---
title: "정적 블로그에 익명 댓글을 붙이면서 알게 된 것들"
description: "GitHub Pages와 Astro로 만든 정적 블로그에 익명 댓글, IP 일부 표시, 삭제 비밀번호, 비공개 댓글을 붙이면서 알게 된 정적 사이트의 한계와 Cloudflare Worker/D1 구조를 정리했습니다."
date: "2026-07-01"
category: "Build Note"
tags: ["Astro", "GitHub Pages", "Cloudflare", "D1", "댓글", "블로그"]
---

GitHub Pages로 블로그를 만들면 빠르고 단순해서 좋습니다. 서버를 직접 운영하지 않아도 되고, Markdown 파일만 쌓아도 글이 계속 남습니다. 그런데 막상 블로그처럼 운영하려고 하면 금방 비어 있는 기능이 보입니다. 대표적인 게 댓글입니다.

처음에는 단순하게 생각했습니다. 사용자가 댓글을 쓰면 GitHub 저장소 어딘가에 저장하면 되지 않을까. 하지만 직접 붙여보니 정적 블로그와 서버가 있는 블로그의 차이가 꽤 분명했습니다.
