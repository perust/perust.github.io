...
Claude Fable 5를 구독제로 쓰다가 7월 7일 이후에는 API를 써야 한다는 말이 돌고 있다. 방향은 맞지만 표현은 조금 다르다. 공식 공지 기준으로 보면, 7월 7일까지는 일부 구독 플랜의 주간 사용량 한도 안에서 Fable 5를 쓸 수 있고, 그 이후에는 usage credits 기반으로 제공된다.
