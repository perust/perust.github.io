---
title: "[혼자 공부하는 바이브 코딩 with 클로드 코드] 1주차 후기: 첫 웹페이지와 프롬프트 설계"
description: "혼자 공부하는 바이브 코딩 with 클로드 코드 완독 챌린지 1주차 기록입니다. 아티팩트로 첫 웹페이지를 만들고, 5W1H와 PRD, 4단계 제작 전략을 정리했습니다."
date: "2026-07-09"
category: "AI"
tags: ["바이브코딩", "Claude", "ClaudeCode", "아티팩트", "프롬프트", "PRD", "AI코딩"]
---

이번 주에는 『혼자 공부하는 바이브 코딩 with 클로드 코드』 완독 챌린지 1주차를 진행했습니다. 범위는 Ch 01의 바이브 코딩 개념과 클로드 아티팩트 실습, 그리고 Ch 02의 효과적인 프롬프트 작성법이었습니다.
...
딸깍 한 번으로 무언가 만들어지는 시대처럼 보이지만, 그 딸깍 한 번이 손쓸 수 없이 커지는 불길이 될 수도 있습니다. 그래서 더 공부하고, 더 작게 나누고, 더 자주 확인하는 습관이 필요하다고 느낀 1주차였습니다.

## 다음 주에 해볼 것

다음 주에는 프롬프트를 더 체계적으로 작성하고, PRD를 먼저 만든 뒤 작은 기능 단위로 구현하는 연습을 해보려고 합니다. 개인 프로젝트인 `우리같이 회고 노트`에도 이 방식을 적용해볼 수 있을 것 같습니다.

우선 다음에는 “전체 앱을 만들어줘”가 아니라, 첫 사용자가 월간 회고를 시작하는 한 화면만 PRD로 정리하고, 뼈대부터 기능, 디자인, 점검 순서로 나눠서 진행해보겠습니다.
