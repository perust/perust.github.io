...
책의 예시 프롬프트를 보면서 "이 정도로 상세하게 작성해야겠구나"라는 생각이 들었습니다. 책에서는 결과 하나를 달라고 요청하는 것이 아니라 일 하나를 맡긴다는 마음으로 적으라고 설명합니다.

단순히 "자료를 비교해줘"라고 말하는 대신 무엇을 찾아야 하는지, 어떤 기준으로 비교해야 하는지, 결과를 어떤 형태로 만들어야 하는지를 같이 적는 방식입니다. 사람에게 일을 맡길 때도 대상과 기준이 없으면 서로 다른 결과를 생각하게 됩니다. AI에게도 같은 문제가 생깁니다.
