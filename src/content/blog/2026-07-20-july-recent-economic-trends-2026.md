...
<ul class="issue-list">
  <li class="issue-card"><h3>고정비</h3><p class="issue-summary">통신비, 보험료, 구독료, 대출이자처럼 자동으로 빠져나가는 지출을 먼저 봅니다. 물가가 3%대일 때는 큰 지출보다 반복 지출이 현금흐름을 더 조용히 갉아먹습니다.</p></li>
  <li class="issue-card"><h3>변동비</h3><p class="issue-summary">식비와 주유비는 물가 영향을 바로 받습니다. 한 달 총액이 아니라 주간 한도로 나누고, 여름 전기요금처럼 다음 달 청구서에 늦게 반영되는 비용을 미리 예산에 넣습니다.</p></li>
  <li class="issue-card"><h3>대출</h3><p class="issue-summary">국고채 금리와 시장금리가 올라가는 구간에서는 변동금리 대출의 다음 금리 재산정일을 확인합니다.</p></li>
  <li class="issue-card"><h3>주거</h3><p class="issue-summary">전세 갱신이 6개월 안에 있다면 보증금 증액, 월세 전환, 대출 한도와 금리, 이사비를 한 번에 계산합니다. 가격은 오르는데 거래량이 줄어드는 구간에서는 조급한 결정보다 자금 조건 확인이 우선입니다.</p></li>
  <li class="issue-card"><h3>투자</h3><p class="issue-summary">반도체·AI 수출 호조에 대한 노출이 이미 큰지 확인합니다. 개별주, ETF, 연금, 해외주식까지 합쳐 같은 방향에 과도하게 몰려 있을 수 있습니다. 환율은 달러 자산 평가액을 키우지만 매수 단가와 생활비도 함께 높입니다.</p></li>
</ul>
