...
description: "Claude Code에서 Claude Fable 5를 /model fable로 선택할 수 있는 흐름을 공식 문서 기준으로 정리했다. 지원 버전, 복구 이력, 비용, 주의점을 확인한다."
...
<ul class="issue-list">
  ...
  <li class="issue-card">
    ...
    <h3><code>/model fable</code>로 선택한다</h3>
