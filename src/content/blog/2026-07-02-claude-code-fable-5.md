---
title: "Claude Code에서 Fable 5 사용 가능? 바이브코더가 체크해야 할 5가지"
description: "Claude Code에서 Claude Fable 5를 /model fable로 선택하는 흐름을 공식 문서 기준으로 정리했다. 지원 버전, 복구 이력, 비용, 주의점을 확인한다."
